...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building ELECTRONIC MEDICAL RECORED SYSTEM",
...
export const projects = [
  ...
  },
  {
    id: 3,
    title: "Telegram Bot",
    des: "It can perform various tasks such as sending messages, responding to commands, providing information, and integrating with third-party services.",
    img: "/TelegramBot.jpeg",
...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "I use backend technologies like Spring Boot (Java) and Node.js to build robust, scalable, and efficient server-side applications.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
